...
class Shorten(models.Model):
    ...
    created_by = models.ForeignKey(get_user_model(),on_delete=models.SET_NULL,related_name="shorten",null=True)
    def __str__(self):
        return self.original
    class Meta:
        ordering = ("-created_on",)
class Tracker(models.Model):
    short_id = models.ForeignKey(Shorten,on_delete=models.CASCADE,related_name="tracker",related_query_name="has_tracker")
